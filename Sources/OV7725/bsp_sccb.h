...
#define DEV_ADR_W   0x42    //SCCB写地址
#define DEV_ADR_R   0x43    //SCCB写地址

#define SCL     PTJ_PTJ6        //SCCB时钟线
#define SDA     PTJ_PTJ7        //SCCB数据线


#define SCL_DR  DDRJ_DDRJ6     //时钟线数据方向
#define SDA_DR  DDRJ_DDRJ7     //数据线数据方向
